...
function(symlink_shaders shader_target)
  set(GAME_SHADERS_PATH "${CMAKE_CURRENT_SOURCE_DIR}/shaders")
  assert_dir_exists("${GAME_SHADERS_PATH}")

  add_custom_command(TARGET ${shader_target} POST_BUILD
    COMMENT "Symlink shaders to $<TARGET_FILE_DIR:${shader_target}>/shaders"
    COMMAND ${CMAKE_COMMAND} -E create_symlink "${GAME_SHADERS_PATH}" "$<TARGET_FILE_DIR:${shader_target}>/shaders"
  )
endfunction()
